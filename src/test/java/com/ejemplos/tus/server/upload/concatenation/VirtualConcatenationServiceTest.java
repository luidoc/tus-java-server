...
class VirtualConcatenationServiceTest {
        ...
        void mergeNotFound() {
                assertThrows(UploadNotFoundException.class, () -> {
                        ...
                        when(uploadStorageService.getUploadInfo(child2.getId().toString(), infoParent.getOwnerKey()))
                                        .thenReturn(null);
                        when(uploadStorageService.getUploadInfo(infoParent.getId().toString(),
                                        infoParent.getOwnerKey()))
                                        .thenReturn(infoParent);
        ...
        void mergeWithExpiration() throws Exception {
                ...
                // We should not update uploads that are still in progress (as they might still
                // being written)
        ...
        void getConcatenatedBytes() throws Exception {
                ...
                assertThat(IOUtils.toString(concatenationService.getConcatenatedBytes(infoParent),
        ...
        private void prepareAndExecuteConcatenation() throws Exception {
                String upload1 = "This is a ";
                String upload2 = "concatenated upload!";
        ...
        void getConcatenatedBytesNotFound() {
                assertThrows(UploadNotFoundException.class, () -> {
                        prepareAndExecuteConcatenation();
                });
