...
class DownloadGetRequestHandlerTest {
        ...
        @Test
        void testWithCompletedUploadWithMetadata() throws Exception {
        ...
        @Test
        void testWithCompletedUploadWithoutMetadata() throws Exception {
                final UploadId id = new UploadId(UUID.randomUUID());
                ...
                assertThat(servletResponse.getHeader(HttpHeader.CONTENT_LENGTH), is("10"));
                assertThat(servletResponse.getHeader(HttpHeader.CONTENT_DISPOSITION),
                                is("attachment; filename=\"" + id.toString() + "\"; filename*=UTF-8''"
                                                + id.toString()));
        ...
        void testWithUnknownUpload() {
                assertThrows(UploadInProgressException.class, () -> {
                        ...
                        verify(uploadStorageService, never()).copyUploadTo(any(UploadInfo.class),
